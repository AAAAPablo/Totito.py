...
canvas1= Canvas(frame1, bg='white', width=200, height =200,highlightthickness=0)
canvas1.grid(column=0,row=0, sticky='nsew')
canvas2= Canvas(frame2, bg='white', width=200, height =200,highlightthickness=0)
canvas2.grid(column=0,row=0, sticky='nsew')
canvas3= Canvas(frame3, bg='white', width=200, height =200,highlightthickness=0)
canvas3.grid(column=0,row=0, sticky='nsew')
texto1 = canvas1.create_text(1,1, text='0', font=('Arial',12,'bold'), fill= 'Black')
texto2 = canvas2.create_text(1,1, text='0', font=('Arial',12,'bold'), fill= 'Black')
texto3 = canvas3.create_text(1,1, text='0', font=('Arial',12,'bold'), fill= 'Black')
...
circulo1 = canvas1.create_oval(10,10,100,100, outline='orange',width=10)
circulo2 = canvas2.create_oval(10,10,100,100, outline='purple',width=10)
circulo3 = canvas3.create_oval(10,10,100,100, outline='black',width=10)
...
stop = Button(frame5, text = 'DETENER', relief = "raised",bd=5, bg='grey20',
